...
export default function ProjectDetailsPage({ params }) {
  ...
  return (
    <main className="bg-white">
      <Banner
        title={""}
        subtitle={<span className="text-base font-medium"><Link>Home</Link> / <Link>Projects & Programmes</Link> / {category.charAt(0).toUpperCase() + category.slice(1)}</span>}
        image="/mdcl/g4.jpg"
      />
      <div className="py-12 md:w-[85%] w-[95%] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mt-4">
          ...
          {/* Right: Images */}
          <div className="flex flex-col md:w-[70%] md:mx-auto gap-6">
